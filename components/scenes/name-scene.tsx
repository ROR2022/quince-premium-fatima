        ...
        <div className="relative z-20 text-center px-6 md:px-8 lg:px-12 space-y-8">
          ...
          <div className="rounded-2xl p-4 md:p-6 lg:p-8">
            <TypewriterText
              text={firstMessage}
              delay={100}
              className="font-main-text text-4xl md:text-6xl lg:text-7xl text-white font-bold tracking-wide drop-shadow-2xl"
          ...
          {secondTextComplete && (
            <div className="animate-fade-in rounded-2xl p-4 md:p-6 lg:p-8">
              <TypewriterText
                text={thirdMessage}
                delay={80}
                className="font-main-text text-3xl md:text-5xl lg:text-6xl text-white font-bold tracking-wide drop-shadow-2xl"
