export const quinceMainData = {
  ...
  event: {
    ...
    parents: {
      father: "Alejandro Chang López", //ALEJANDRO CHANG LÓPEZ
      mother: "Nadya Juarez Yañez", //NADYA JUAREZ YAÑEZ
  ...
  dressCode:{
    ...
    subtitle: "Lila y Azul claro solo la quinceañera",
  ...
  attendance: {
    whatsappNumber: "5215523020574", //+52 1 348 151 4862 Mi num es 5523020574
